...
const features = [
  {
    ...
    content: {
      heading:
        "Never lose sight of your pet's location, no matter where they roam.",
    },
  },
  {
    id: "activity",
  ...
  },
  {
    ...
    content: {
      heading:
        "Set up virtual boundaries and get alerts when your pet crosses them.",
    },
  },
  {
    id: "health",
            ...
            <div className="space-y-6">
              ...
              <div className="absolute -bottom-28 w-full left-0 flex">
                <div className="w-1/4 bg-white h-28 rounded-[50px] z-10 flex items-center justify-evenly ">
                  <ArrowLeft
                    className="text-foreground h-10 w-10 p-2 cursor-pointer"
                    onClick={handlePrev}
                  />
                  <ArrowRight
                    className="text-white bg-primary h-10 w-10 rounded-full p-2 cursor-pointer"
                    onClick={handleNext}
                  />
                </div>
        ...
        <Carousel className="w-full">
          <CarouselContent className="h-[28rem] w-11/12 -ml-4">
            {features.map((feature) => (
              <CarouselItem
                key={feature.id}
                className="h-full pl-4 md:basis-3/5"
              >
